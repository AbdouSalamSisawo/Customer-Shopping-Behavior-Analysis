...
SELECT Subscription_status, COUNT(customer_id) AS Total_Customers, SUM(purchase_amount) AS revenue, AVG(purchase_amount) AS 'Average Purchase Amount' FROM customer
...
SELECT age_group, SUM(purchase_amount) AS Revenue_Total
FROM customer
GROUP BY age_group
